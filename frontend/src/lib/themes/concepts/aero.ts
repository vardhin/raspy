...
export default {
	...
	tokens: {
		...
		// interaction
		'--shadow-hover': '0 10px 30px color-mix(in srgb, var(--accent) 30%, rgba(0,0,0,0.25))',
		'--hover-lift': '-2px',
		'--hover-glow': '0 0 24px color-mix(in srgb, var(--accent) 35%, transparent)',
	...
	effects: [{"kind":"breathe","opacity":0.35}],
