...
<Stack gap={5}>
	<Stack gap={1}>
		<Text role="title">Theme</Text>
		<Text role="muted">
			Pick a color palette and a concept (form & material). They compose freely —
			currently <b>{theme.color.name}</b> × <b>{theme.concept.name}</b>. Changes apply
